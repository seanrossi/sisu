...
urlpatterns = [
    ...
    url(r'^story/category/(?P<category_name>\w+)$', views.story, name='story'),
    url(r'^story_entry/(?P<pk>\d+)/$', views.story_entry, name='story_entry'),
    ...
    url(r'^user_details/user_id/(?P<pk>\d+)/edit$', views.user_edit, name='user_edit'),
